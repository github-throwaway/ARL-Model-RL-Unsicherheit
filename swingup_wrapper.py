...
class SwingUpWrapper(gym.Env):
    ...
    def __init__(self, offset=1, min_range=0.56 + math.pi, max_range=(math.pi/2)*3):
    #def __init__(self, offset=1, min_range=0, max_range=2* math.pi):
    ...
    def step(self, action):
        ...
        if self.min_range < pole_angle < self.max_range:
            ...
            fake_angular_velocity = observation[4] + fake[0]*100 - (pole_angle - fake_observation)
            my_obs.append(fake_angular_velocity)
...
if __name__ == "__main__":
    ...
    for _ in range(10):
        ...
        while not done:
            ...
            #append fake winkelgeschwindigkeit!!!!!
