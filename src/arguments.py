...
def collect_arguments():
    ...
    parser.add_argument("--nn_model", default="default", type=str,
                        help="Define the filename of the model you want to save/load.")

    parser.add_argument("--ppo_folder", default="./ppo/", type=str,
                        help="Define a folder, where you want to save/load your trained ppo agent to/from.")
    ...
    parser.add_argument("--reward", default="simple", type=str,
                        help="Define twhich reward-function should be used. simple | simple_pos | ")
